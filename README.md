        ...
        <div id="container">
            <div id="headerArea">
                ...
                <nav id="navbar">
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li><a href="#">Miranda Gallery</a></li>
                        <li><a href="#">Creations</a></li>
                        <li><a href="#">Browse my CDs</a></li>
            ...
            <div id="flex">
                <aside id="leftSidebar">
                    <h2>Updates</h2>
                    <div class="box">
                        <img src="https://jaffa.neocities.org/Images/image.jpg" alt="desc">
                        <ul style="padding-left:10px;">
                            <h1 style="color:red;">*LIVE WEBCAM.</h1>
                        </ul>
                    </div>
                    <h2>Heading 2</h2>
                    <h3>Heading 3</h3>
                ...
                <main>
                    <h1>Welcome to jaffa.miranda.gov.uk</h1>
                    <p><strong>Live webcam in progress.</strong></p>
                    <p>Paragraph 1!!!</p>
            ...
            <footer id="footer">© 2025 JAFFADREAMING CO. , LTD. All rights reserved. Licensed by Miranda Dreaming Ltd.</footer>
        </div>
        <!-- THIS IS THE CSS !-->
        <style>
            /* user styles */
    ...
    the images as variables */
            ...
            :root {
                --header-image: url('https://jaffa.neocities.org/Images/Header2.png');
    ...
    */
            ...
            @font-face {
                ...
                src: url('https://jaffa.neocities.org/NeueHaasGrotesk/NeueHaasDisplayRoman.ttf');
            }

            @font-face {
                font-family: NeueHaasDisplay;
                src: url('https://jaffa.neocities.org/NeueHaasGrotesk/NeueHaasDisplayMediu.ttf');
                font-weight: bold;
            }

            @font-face {
                font-family: NeueHaasDisplay;
                src: url('https://jaffa.neocities.org/NeueHaasGrotesk/NeueHaasDisplayRomanItalic.ttf');
                font-style: italic;
            }

            @font-face {
                font-family: NeueHaasDisplay;
                src: url('https://jaffa.neocities.org/NeueHaasGrotesk/NeueHaasDisplayBoldItalic.ttf');
                font-style: italic;
                font-weight: bold;
            }
